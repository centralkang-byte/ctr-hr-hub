...
export const TABLE_STYLES = {
  wrapper: 'relative w-full overflow-auto rounded-xl border border-border shadow-sm bg-card',
  table: 'w-full caption-bottom text-sm border-collapse text-left',
  header: 'sticky top-0 z-10 bg-muted/50 [&_tr]:border-b border-border',
  ...
  row: 'border-b border-border transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted group',
  rowClickable: 'border-b border-border transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted group cursor-pointer',
  ...
  pagination: 'flex items-center justify-between px-5 py-3 border-t border-border bg-muted/50',
} as const
