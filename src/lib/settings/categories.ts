import {
  Calendar, BarChart3, Banknote, UserPlus, TrendingUp, Cog,
  type LucideIcon,
} from 'lucide-react'
...
export const SETTINGS_CATEGORIES: SettingsCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'methodology', label: '평가 방법론', description: 'MBO/MBO+BEI 병행 여부, 업적·역량 비중, 종합등급 산출 방식 법인별 설정' },
      { id: 'forced-distribution', label: '강제배분', description: 'Soft/Hard 강제배분 선택, 등급별 최소·최대 비율 설정' },
  ...
  },
  {
    ...
    items: [
      { id: 'job-levels', label: '직급체계', description: '직급 정의, 승진 경로, 직급별 권한 매핑 법인별 설정' },
      { id: 'promotion-rules', label: '승진요건', description: '직급 간 최소 체류기간, 필요 평가등급 매트릭스' },
      { id: 'approval-chain', label: '결재선 설정', description: '승진 결재 단계, 단계별 승인자 역할 설정' },
  ...
  },
  {
    ...
    items: [
      { id: 'pay-components', label: '급여항목', description: '기본급/각종 수당/비과세 항목 등 급여 구성요소 법인별 정의' },
      ...
      { id: 'bonus-rules', label: '성과급 규칙', description: '등급 기반/이익분배/혼합 성과급 유형, 등급별 지급 월수 설정' },
