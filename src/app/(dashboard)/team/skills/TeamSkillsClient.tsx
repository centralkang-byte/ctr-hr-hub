                ...
                <div key={catId}>
                  ...
                  <div className="space-y-4">
                    {items.map((a) => {
                      ...
                      return (
                        <div key={a.competencyId} className="bg-background rounded-lg p-4">
                          ...
                          {current && (
                            <input
                              ...
                              className="mt-2 w-full px-3 py-1.5 border border-border rounded-lg text-sm focus:ring-2 focus:ring-primary/10"
                            />
                          )}
                        </div>
                      )
