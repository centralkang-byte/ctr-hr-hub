...
const TABS = [
  { key: 'turnover', label: '이직예측', icon: TrendingDown },
  { key: 'burnout', label: '번아웃', icon: Activity },
  { key: 'team', label: '팀건강', icon: Heart },
  { key: 'workforce', label: '인력현황', icon: Users },
] as const
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-3">
            ...
            {data.length === 0 && (
              <p className="text-sm text-[#999] text-center py-8">스코어 데이터 없음</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-[#E8E8E8]">
        <div className="px-5 py-4 border-b border-[#F5F5F5]">
          <h3 className="text-base font-semibold text-[#1A1A1A]">이직 위험 전체 목록</h3>
        </div>
                ...
                <tr key={row.employeeId} className={TABLE_STYLES.header}>
                  ...
                  <td className="px-4 py-3">
                    {row.latestScore ? (
                      ...
                      <span className="text-xs text-[#999]">미계산</span>
                    )}
                  </td>
                  <td className="px-4 py-3">
...
function BurnoutTab({ data }: { data: BurnoutRow[] }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-[#E8E8E8]">
        <div className="px-5 py-4 border-b border-[#F5F5F5]">
          <h3 className="text-base font-semibold text-[#1A1A1A]">번아웃 전체 목록</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
...
function TeamHealthTab({ data }: { data: TeamHealthRow[] }) {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-3">
            ...
            {data.filter((d) => ['high', 'critical'].includes(d.latestScore?.riskLevel ?? '')).length === 0 && (
              <p className="text-sm text-[#059669] text-center py-8">모든 팀이 건강합니다 ✓</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-[#E8E8E8]">
        <div className="px-5 py-4 border-b border-[#F5F5F5]">
          <h3 className="text-base font-semibold text-[#1A1A1A]">팀 건강 전체 현황</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
...
function WorkforceTab({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-[#E8E8E8]">
        <div className="px-5 py-4 border-b border-[#F5F5F5]">
          <h3 className="text-base font-semibold text-[#1A1A1A]">부서별 통합 현황</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-[#666]">HR_ADMIN 전용 — 직원 본인 열람 불가</span>
        </div>
