  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold text-slate-900">내 급여명세서</h1>
      </div>
            ...
            >
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-sm">
                  <span className="text-slate-500">총 지급액</span>
                  <span className="font-medium">{formatCurrency(Number(item.grossPay))}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-slate-500">공제액</span>
                ...
                <div className="flex justify-between text-sm font-bold pt-1.5 border-t border-slate-100">
                  <span className="text-blue-700">실수령액</span>
