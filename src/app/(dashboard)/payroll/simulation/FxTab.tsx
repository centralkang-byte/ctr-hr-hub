    ...
    <div className="space-y-6">
      ...
      <div className={CARD_STYLES.padded}>
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-sm font-semibold text-[#1C1D21]">{t('simFxTitle')}</h3>
            <p className="text-xs text-[#8181A5] mt-0.5">{t('simFxDesc')}</p>
          </div>
        ...
        <div className="flex items-center justify-between mt-4">
          <span className="text-xs text-[#8181A5]">{t('simFxOverseasTarget', { count: overseasCount })}</span>
          <button
      ...
      {summary && (
        <>
          ...
          {chartData.length > 0 && (
            <div className={CARD_STYLES.padded}>
              <h3 className="text-sm font-semibold text-[#1C1D21] mb-4">{t('simFxChartTitle')}</h3>
          ...
          {/* ── 법인 영향 테이블 ── */}
          <div className={CARD_STYLES.padded}>
            <h3 className="text-sm font-semibold text-[#1C1D21] mb-3">{t('simFxImpactTitle')}</h3>
            <div className={TABLE_STYLES.wrapper}>
              <table className={TABLE_STYLES.table}>
                <thead>
                  <tr className={TABLE_STYLES.header}>
          ...
          {sensitivity.length > 0 && (
            <div className={CARD_STYLES.padded}>
              <h3 className="text-sm font-semibold text-[#1C1D21] mb-3">{t('simFxSensitivityTitle')}</h3>
              <p className="text-xs text-[#8181A5] mb-3">{t('simFxSensitivityDesc')}</p>
              <div className={TABLE_STYLES.wrapper}>
                <table className={TABLE_STYLES.table}>
                  <thead>
                    <tr className={TABLE_STYLES.header}>
