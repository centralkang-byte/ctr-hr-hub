  ...
  return (
    <div className="space-y-4">
      <div className="mb-4 flex items-center justify-between">
        <div><h3 className="text-base font-semibold text-foreground">{t('deductions.title')}</h3><p className="text-sm text-muted-foreground">{t('deductions.subtitle', { count: items.length })}</p></div>
