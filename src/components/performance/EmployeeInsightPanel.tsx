              ...
              {data.successionEntry ? (
                <div className="bg-background rounded-lg p-2.5">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${READINESS_BADGE[data.successionEntry.readiness]?.color ?? 'bg-muted text-[#666]'}`}>
                  ...
                  {data.successionEntry.notes && (
                    <p className="text-xs text-[#666] mt-1 border-t border-border pt-1.5">
                      {data.successionEntry.notes}
                    </p>
                  )}
                </div>
