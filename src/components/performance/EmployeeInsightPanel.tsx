          ...
          <div className="p-4 space-y-5">
                    ...
                    return (
                      <div key={goal.id} className="bg-[#FAFAFA] rounded-lg p-2.5">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-xs font-semibold text-[#333] whitespace-nowrap w-10 text-right">
              ...
              {data.successionEntry ? (
                <div className="bg-[#FAFAFA] rounded-lg p-2.5">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${READINESS_BADGE[data.successionEntry.readiness]?.color ?? 'bg-[#F5F5F5] text-[#666]'}`}>
                  ...
                  {data.successionEntry.notes && (
                    <p className="text-xs text-[#666] mt-1 border-t border-[#F5F5F5] pt-1.5">
                      {data.successionEntry.notes}
                    </p>
                  )}
                </div>
            ...
            <div className="pt-2">
              <a
                ...
                className="flex items-center justify-between w-full px-3 py-2 bg-white border border-[#E8E8E8] rounded-lg hover:bg-[#FAFAFA] text-sm text-[#333] transition-colors"
              >
                <span>직원 프로필 보기</span>
