      ...
      {period === 'custom' && (
        <div className="flex flex-wrap items-center gap-3 p-3 bg-white rounded-xl border border-gray-100">
          ...
          <button
            ...
            className="px-4 py-1.5 text-sm font-medium rounded-lg bg-[#5E81F4] text-white hover:bg-[#4B6DE0] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            적용
          </button>
        </div>
