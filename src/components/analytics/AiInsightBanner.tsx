...
export function AiInsightBanner() {
  ...
  return (
    <Link href="/analytics/ai-report" className="block">
      <div className="relative overflow-hidden rounded-xl border border-primary/20 bg-gradient-to-r from-primary/5 via-primary/5 to-white p-4 mb-6 hover:shadow-md hover:border-[#4F46E5]/30 transition-all group cursor-pointer">
        <div className="flex items-center gap-3">
          <div className="flex-shrink-0 rounded-lg bg-gradient-to-br from-[#4F46E5] to-[#8B5CF6] p-2">
          ...
          <ArrowRight className="h-4 w-4 text-gray-400 group-hover:text-[#4F46E5] group-hover:translate-x-0.5 transition-all flex-shrink-0" />
        </div>
