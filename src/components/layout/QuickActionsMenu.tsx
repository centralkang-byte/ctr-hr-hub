    ...
    return (
        <div ref={containerRef} className="relative">
            ...
            {open && (
                <div
                    role="menu"
                    className="absolute right-0 top-full z-50 mt-2 min-w-[220px] rounded-xl border border-[#F0F0F3] bg-white p-2 shadow-lg"
                >
                    {/* Header */}
                    <p className="mb-1 px-3 pb-1 pt-0.5 text-xs font-medium text-[#8181A5]">
                        {t('quickActions')}
                    </p>

                    {/* Divider */}
                    <div className="mb-1 border-t border-[#F0F0F3]" />
                    ...
                    {visibleActions.map((action) => {
                        ...
                        return (
                            <button
                                ...
                                type="button"
                                role="menuitem"
                                className="flex w-full cursor-pointer items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-[#1C1D21] transition-colors hover:bg-[#F5F5FA]"
                                onClick={() => handleAction(action.route)}
                            >
                                <Icon className="h-4 w-4 text-[#8181A5]" />
