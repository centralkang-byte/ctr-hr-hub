  ...
  return (
    <div className="relative">
      <button
        ...
        disabled={disabled}
        onClick={() => setOpen((p) => !p)}
        className="flex w-full items-center justify-between gap-2 rounded-lg border border-[#D4D4D4] bg-white px-3 py-2 text-sm text-[#333] hover:border-[#00C853] focus:outline-none focus:ring-2 focus:ring-[#00C853]/20 disabled:cursor-not-allowed disabled:bg-[#FAFAFA] disabled:text-[#999]"
      >
