          ...
          <div className="max-h-[calc(100vh-200px)] overflow-y-auto px-6 py-5 space-y-5">
            ...
            {success ? (
              ...
              <div className="flex flex-col items-center gap-4 py-8 text-center">
                ...
                <button
                  onClick={handleClose}
                  className="mt-2 rounded-lg bg-warm px-6 py-2.5 text-sm font-semibold text-white hover:brightness-95 transition-colors"
                >
                  {t('confirm')}
                </button>
              </div>
          ...
          {!success && (
            <div className="flex justify-end gap-2.5 border-t border-border px-6 py-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg bg-warm px-4 py-2 text-sm font-semibold text-white hover:brightness-95 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {loading ? (
                  <>
