    ...
    <div className="border border-[#E8E8E8] rounded-xl p-4 space-y-3 bg-white">
      ...
      <div className="flex items-center gap-2">
        ...
        <select
          ...
          className="text-sm border border-[#D4D4D4] rounded-lg px-2 py-1 bg-white focus:outline-none focus:ring-2 focus:ring-[#00C853]/10"
        >
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              placeholder="신설 부서명"
              className="w-full px-3 py-1.5 text-sm border border-[#D4D4D4] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00C853]/10 placeholder:text-[#999]"
            />
          </div>
          <div>
          ...
          <div className="col-span-2">
            ...
            <select
              ...
              className="w-full px-3 py-1.5 text-sm border border-[#D4D4D4] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00C853]/10"
            >
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#E8E8E8] shrink-0">
          <div className="flex items-center gap-2">
            <GitBranch size={18} className="text-[#00C853]" />
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm border border-[#D4D4D4] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00C853]/10 placeholder:text-[#999]"
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-[#E8E8E8] bg-[#FAFAFA] shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-4 py-2 text-sm bg-[#00C853] hover:bg-[#00A844] text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {saving
                ? '처리 중...'
                : step === 'edit'
