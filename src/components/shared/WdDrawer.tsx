...
/** 라벨 + 컨트롤 + (선택)도움말 수직 스택. */
export function WdField({ label, required, hint, help, children }: WdFieldProps) {
  return (
    <div className="flex flex-col gap-1.5">
      <label className="flex items-center gap-1 text-[11.5px] font-semibold text-muted-foreground">
        {label}
