 ...
 *
 * 출력:
 *   docs/uat/screenshots-v2/01-home-{role}.png
 */
...
const OUTPUT_DIR = path.join(__dirname, '../docs/uat/screenshots-v2')
...
const PAGES: Array<{ slug: string; path: string; label: string }> = [
  ...
  { slug: 'approvals-inbox', path: '/approvals/inbox', label: '결재함' },
