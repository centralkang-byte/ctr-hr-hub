...
- **Cron 미등록**: [11_Cron_수동_트리거.md](11_Cron_수동_트리거.md) 참조. 5개 cron이 등록 전까지 알림 silent.

## 관련 문서

- [11_Cron_수동_트리거.md](11_Cron_수동_트리거.md) — cron 미동작 영향
- [10_장애_대응.md](10_장애_대응.md) — 알림 발송 실패 시 대응
