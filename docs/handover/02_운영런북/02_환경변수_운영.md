...
> **대상**: 인프라팀
> **참고**: 전체 환경 변수 인벤토리는 [03_보안_환경변수_인벤토리.md](../03_보안_환경변수_인벤토리.md) (자동 생성).
...
- [ ] 핸드오버 [05_벤더_계약.md](../05_벤더_계약.md) 에도 외부 서비스 추가
...
자세한 회전 절차: [03_보안_환경변수_인벤토리.md §시크릿 회수·교체 SOP](../03_보안_환경변수_인벤토리.md#시크릿-회수교체-sop)
...
- [03_보안_접근권한.md](../03_보안_접근권한.md) — IAM owner + 시크릿 회수
